...
var url = '/api2/v2/chats/18616240/media?limit=6';

var dynamicRules = {
  checksum_constant: -352,
  checksum_constants: [
    119, -133, -135, 103, -113, -99, -82, 125, -133, 133, 136, -72, -134, -119,
    -93, -114, -101, 91, -116, 88, -62, 56, 124, -118, 70, -99, 138, -90, 130,
    126, 84, -62,
  ],
  static_param: 'hsHDdnYtOMK1k7nycUWmn526HsubpNAY',
  format: '6251:{}:{:x}:639d5daf',
  checksum_indexes: [
    12, 28, 16, 39, 25, 0, 18, 21, 36, 26, 27, 2, 7, 13, 7, 20, 10, 25, 20, 20,
    35, 15, 35, 26, 8, 19, 12, 10, 17, 28, 12, 9,
  ],
  error_code: 0,
  message: '',
...
var fullUrl = 'https://onlyfans.com/api2/v2/chats/18616240/media?limit=6';

var additionalHeaders = [
  { name: 'app-token', value: '33d57ade8c02dbc5a333db99ff9ae26a' },
  { name: 'x-bc', value: '2aa8b90720500425de2b480e377fca83c0330e9d' },
];
